...
public class ReadDataTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RequestQueue queue = Volley.newRequestQueue(ReadDataTwo.this);
                ...
                IntStream.range(1, jsonArray.length())
                        .forEach(i -> {
                            try {
                                ...
                                strMoisture = json.getString(1);   //I don't know why I can't use soilMoisture for the ArrayList, check it out.
