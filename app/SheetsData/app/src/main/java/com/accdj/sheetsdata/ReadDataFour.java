...
public class ReadDataFour extends AppCompatActivity {

    String sheetsID = "1RcYlmxQAznj83vKuDPzCUz2ENzumkxtC3WUML4Wr3Mg";
    String apiKEY = "API KEY GOES HERE";    String strMoisture;
    String strDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RequestQueue queue = Volley.newRequestQueue(ReadDataFour.this);
                ...
                IntStream.range(1, jsonArray.length())
                        .forEach(i -> {
                            try {
                                ...
                                strMoisture = json.getString(3);   //I don't know why I can't use soilMoisture for the ArrayList, check it out.
