...
public class ReadData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RequestQueue queue = Volley.newRequestQueue(ReadData.this);
                ...
                IntStream.range(1, jsonArray.length())
                        .forEach(i -> {
                            try {
                                ...
                                strMoisture = json.getString(0);
                                strDate = json.getString(5);

                                soilMoisture.add(0, strMoisture);   //I don't know why I can't use soilMoisture for the ArrayList, check it out.
                                date.add(0, strDate);
